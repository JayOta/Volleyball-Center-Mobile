...
class _CadastroState extends State<Cadastro> {
  ...
  Future<void> _cadastrar() async {
    ...
    try {
      ...
      print('Verificando se Firebase está inicializado...');
      
      if (Firebase.apps.isEmpty) {
        throw 'Firebase não foi inicializado corretamente';
      }
      
      print('Firebase está inicializado. Apps disponíveis: ${Firebase.apps.length}');

      // Criar conta no Firebase
      print('Tentando criar conta...');
      ...
      if (userCredential?.user != null) {
        ...
        throw 'Falha ao criar usuário - userCredential é null';
      }
    } catch (e) {
                    ...
                    builder: (context, snapshot) {
                      return Container(
                        ...
                        decoration: BoxDecoration(
                          color: snapshot.data == true ? Colors.green.shade100 : Colors.red.shade100,
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            Text(
                              snapshot.data == true ? 'Firebase conectado' : 'Firebase não conectado',
                              style: TextStyle(
                                color: snapshot.data == true ? Colors.green.shade800 : Colors.red.shade800,
                                fontSize: 12,
                              ),
                            ),
                          ],
                  ...
                  SizedBox(
                    ...
                    child: TextFormField(
                      ...
                      decoration: InputDecoration(
                        ...
                        prefixIcon: const Icon(Icons.person, color: Color(0xFF14276B)),
                      ),
                      validator: (value) {
