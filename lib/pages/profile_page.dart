                    ...
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          _buildInfoRow('Display Name:', currentUser?.displayName ?? 'N/A'),
                          _buildInfoRow(
                            'Email Verificado:', 
                            currentUser?.emailVerified == true ? 'Sim' : 'Não'
                          ),
                          _buildInfoRow(
                            'Criado em:', 
                            currentUser?.metadata.creationTime?.toString() ?? 'N/A'
                          ),
                        ],
                      ),
                    ),
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          if (_userProfile != null) ...[
                            _buildInfoRow('Nome:', _userProfile!['name'] ?? 'N/A'),
                            _buildInfoRow('Email:', _userProfile!['email'] ?? 'N/A'),
                            _buildInfoRow('UID:', _userProfile!['uid'] ?? 'N/A'),
                            _buildInfoRow('Ativo:', _userProfile!['isActive'] == true ? 'Sim' : 'Não'),
                            _buildInfoRow(
                              'Criado em:', 
                              _userProfile!['createdAt']?.toDate()?.toString() ?? 'N/A'
                            ),
                            _buildInfoRow(
                              'Atualizado em:', 
                              _userProfile!['updatedAt']?.toDate()?.toString() ?? 'N/A'
                            ),
                          ] else ...[
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          _buildExampleCard(
                            ...
                            currentUser?.emailVerified == true ? Icons.verified : Icons.warning,
                          ),
